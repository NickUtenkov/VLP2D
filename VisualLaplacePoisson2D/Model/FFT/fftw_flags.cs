...
namespace FFTWSharp
{
	...
	public enum fftw_r2r_kind : uint
	{//https://www.fftw.org/fftw3_doc/More-DFTs-of-Real-Data.html
		FFTW_R2HC = 0,
		FFTW_HC2R = 1,
		FFTW_DHT = 2,
		FFTW_REDFT00 = 3,//Discrete Cosine Transform Type-I
		FFTW_REDFT01 = 4,//Discrete Cosine Transform Type-III
		FFTW_REDFT10 = 5,//Discrete Cosine Transform Type-II
		FFTW_REDFT11 = 6,//Discrete Cosine Transform Type-IV
		FFTW_RODFT00 = 7,//Discrete Sine Transform Type-I
		FFTW_RODFT01 = 8,//Discrete Sine Transform Type-III
		FFTW_RODFT10 = 9,//Discrete Sine Transform Type-II
		FFTW_RODFT11 = 10,//Discrete Sine Transform Type-IV
	}
}
