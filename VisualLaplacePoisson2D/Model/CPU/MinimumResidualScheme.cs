...
{
	class MinimumResidualScheme<T> : Iterative2DScheme<T>, IScheme<T> where T : unmanaged, INumber<T>, ITrigonometricFunctions<T>, ILogarithmicFunctions<T>, IRootFunctions<T>, IMinMaxValue<T>, IPowerFunctions<T>, IExponentialFunctions<T>, IHyperbolicFunctions<T>
	{
		...
		public MinimumResidualScheme(RectangleData<T> rectData, Func<T, T, T> fKsi, T eps) :
