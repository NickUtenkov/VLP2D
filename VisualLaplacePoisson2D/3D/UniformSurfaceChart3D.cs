...
namespace WPFChart3D
{
    class UniformSurfaceChart3D: SurfaceChart3D
    {
        ...
        public void SetGrid(int xNo, int yNo, float xMin, float xMax, float yMin, float yMax, ParallelOptions optionsParallel)
        {
            SetDataNo(xNo * yNo);
            m_nGridXNo = xNo;
            m_nGridYNo = yNo;
            ...
            float dy = (m_yMax - m_yMin) / ((float)yNo - 1);
			   Parallel.For(0, xNo, optionsParallel, i =>
			   {
        ...
        public ArrayList GetMeshes(ParallelOptions optionsParallel)
        {
            ...
            surfaceMesh.SetSize(m_nGridXNo * m_nGridYNo, 2 * (m_nGridXNo - 1) * (m_nGridYNo - 1));
			   ...
			   Parallel.For(0, m_nGridXNo, optionsParallel, i =>
			   {
            ...
            // set triangle
				Parallel.For(0, m_nGridXNo - 1, optionsParallel, i =>
				{
